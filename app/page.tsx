...
export default function Home() {
  return (
    <main className="w-full relative flex flex-col items-center bg-background">
      <Hero />
      <ProjectGallery />
      <TechStack />
      ...
      <footer id="contact" className="w-full pt-16 pb-12 px-4 flex flex-col items-center justify-center relative overflow-hidden z-20">
        ...
        <div className="relative w-full max-w-5xl rounded-[2.5rem] p-[1px] bg-gradient-to-br from-[#dce4e1] to-[#f4f7f6] dark:from-accent-cyan/30 dark:via-white/5 dark:to-accent-purple/30 mb-16 shadow-[0_20px_60px_rgba(0,0,0,0.05)] dark:shadow-[0_30px_80px_rgba(168,85,247,0.15)] z-10">
          
          {/* Outer GAP layer */}
          <div className="w-full h-full bg-[#dce4e1] dark:bg-[#030305] backdrop-blur-3xl rounded-[2.5rem] p-2.5 md:p-4 flex flex-col items-center justify-center relative shadow-[inset_0_0_20px_rgba(255,255,255,0.5)] dark:shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
             
             {/* Inner FRAME layer */}
             <div className="w-full h-full bg-[#f4f7f6]/90 dark:bg-[#07070a] rounded-[2rem] p-12 md:p-20 flex flex-col items-center justify-center text-center relative overflow-hidden border border-white/50 dark:border-white/10 shadow-[inset_0_20px_40px_rgba(0,0,0,0.05)] dark:shadow-[inset_0_40px_100px_rgba(0,0,0,0.8)] backdrop-blur-sm">
               ...
               <div className="relative z-10 flex flex-col items-center w-full">
                 ...
                 <span className="text-foreground dark:text-accent-purple text-[9px] md:text-[10px] tracking-[0.4em] font-bold uppercase mb-12 dark:drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]">SAAS / DASHBOARD</span>
